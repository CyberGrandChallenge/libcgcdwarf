# $Id: Makefile 2075 2011-10-27 03:47:28Z jkoshy $

INCLUDES += -I/usr/include/libcgcef
...
SRCS=	\
	...
	libdwarf_die.c		\
	libdwarf_error.c	\
	libdwarf_cgcef_access.c	\
	libdwarf_cgcef_init.c	\
	libdwarf_frame.c	\
	libdwarf_info.c		\
	libdwarf_init.c		\
	libdwarf_lineno.c	\
...
MLINKS+= \
	...
	dwarf_init.3	dwarf_cgcef_init.3		\
...
install:
	...
	install libdwarf.h $(DESTDIR)/usr/include/libcgcdwarf.h
	install dwarf.h $(DESTDIR)/usr/include/cgcdwarf.h

clean:
	rm -rf $(TARGET) $(OBJS) $(GENSRCS)
